      ...
      <div className="container flex flex-col justify-center px-4 py-8 mx-auto md:p-8">
        ...
        <div className="space-y-4">
          <details className="w-full border rounded-lg">
            <summary className="px-4 py-6 dark:text-black focus:outline-none focus-visible:dark:text-black">
          ...
          <details className="w-full border rounded-lg">
            <summary className="px-4 py-6 focus:outline-none dark:text-black focus-visible:dark:text-black">
